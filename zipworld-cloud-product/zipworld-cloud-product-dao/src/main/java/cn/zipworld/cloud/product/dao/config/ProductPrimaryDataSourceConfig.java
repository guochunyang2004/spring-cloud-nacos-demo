package cn.zipworld.cloud.product.dao.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "cn.zipworld.cloud.product.dao", sqlSessionTemplateRef = ProductPrimaryDataSourceConfig.Prefix.value+"SqlSessionTemplate")
public class ProductPrimaryDataSourceConfig {
